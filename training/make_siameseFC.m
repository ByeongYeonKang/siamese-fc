...
%     add_pair_of_rgb_and_of(two_stream_net, net, ...
%                         {'RGB', 'OF'}, ...
%                         {'RGB_a_feat', 'RGB_b_feat', 'OF_a_feat', 'OF_b_feat'}, ...
%                         false);

%     two_stream_net.addLayer('exemplar_fusion', Fusion(), ...
%                  {'RGB_a_feat', 'OF_a_feat'}, ...
%                  {'exemplar_fusion_out'}, ...
%                  {});         

%     two_stream_net.addLayer('instace_fusion', Fusion(), ...
%                  {'RGB_b_feat', 'OF_b_feat'}, ...
%                  {'instance_fusion_out'}, ...
%                  {});         
    ...
    net.addLayer('xcorr', XCorr(), ...
                 ...
                 {'xcorr_out'}, ...
                 {});        
%     two_stream_net.addLayer('xcorr', XCorr(), ...
%                  {'exemplar_fusion_out', 'instance_fusion_out'}, ...
%                  {'xcorr_out'}, ...
%                  {});   
%              
...
%     add_adjust_layer(two_stream_net, 'adjust', 'xcorr_out', 'score', ...
%                  {'adjust_f', 'adjust_b'}, 1e-3, 0, 0, 1);
